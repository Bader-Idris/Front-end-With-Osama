...
server.listen(5000)// the port, to start, run module, then access localhost:5000 as its port 
// to see different results run localhost:5000 then make its location.hash as
//  /
//  /about
//  /error || any non-existing dash to see error message